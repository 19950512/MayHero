...
import { MONSTER_BY_ID, MONSTERS } from './monsters'
import { CITIES, DUNGEONS, DUNGEON_BY_ID } from './cities'
import type { Equipment } from './types'

export const XP_CURVE = (level: number) => Math.floor(100 * Math.pow(level, 1.5))

export { BASE_STATS, LEVEL_STAT_GROWTH, CLASS_ICONS, CITIES, DUNGEONS, DUNGEON_BY_ID, MONSTERS, MONSTER_BY_ID, ITEM_CATALOG, ITEM_BY_ID, EQUIPMENT_POOL }
